...
public class GraphUtilsBipartiteTest {
    ...
    public void testIsBipartiteCycleOfThree() throws Exception {
        ...
        assertFalse(GraphUtilsBipartite.isBipartite(g));
    }
